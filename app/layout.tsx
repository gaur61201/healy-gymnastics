...
export const metadata: Metadata = {
  ...
  description:
    'Elite gymnastics training for children aged 3–16 in Kuwait. FIG-certified coaches. Programs include recreational, competitive, rhythmic, and boys artistic gymnastics. Book your free trial today.',
  keywords:
    'gymnastics Kuwait, gymnastics academy Kuwait, kids gymnastics Kuwait, rhythmic gymnastics Kuwait, competitive gymnastics Kuwait, Salmiya gymnastics, HGA Kuwait',
  ...
  openGraph: {
    ...
    title: "Healy Gymnastics Academy | Kuwait's #1 Gymnastics Academy Since 2013",
    description:
      'Elite gymnastics training for children aged 3–16 in Kuwait. FIG-certified coaches. Book your free trial today.',
    images: [
      {
        url: '/images/logo.png',
        width: 400,
  ...
  twitter: {
    ...
    description:
      'Elite gymnastics training for children aged 3–16 in Kuwait. FIG-certified coaches.',
...
const jsonLd = {
  ...
  description:
    "Kuwait's #1 Gymnastics Academy Since 2013. Elite gymnastics training for children aged 3–16.",
  url: 'https://www.healygym.com',
...
const fontVars = `${bebasNeue.variable} ${cormorantGaramond.variable} ${dmSans.variable} ${notoKufiArabic.variable} ${cairo.variable}`;
